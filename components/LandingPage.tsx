...
import { ArrowRight, Check, Zap, Layout, Shield, Smartphone, Play, Command, FileText, Tags, MousePointer2, Lock, Sparkles, Database, Send, Layers } from 'lucide-react';
            ...
            <div className="max-w-4xl mx-auto px-6 text-center">
                <div className="bg-gray-900 rounded-[2.5rem] p-12 md:p-20 text-white relative overflow-hidden shadow-2xl">
                    ...
                    <div className="relative z-10">
                        ...
                        <button 
                            onClick={onGetStarted}
                            className="px-10 py-4 bg-white text-gray-900 hover:bg-gray-100 text-base font-bold rounded-2xl transition-all shadow-xl active:scale-95 flex items-center justify-center gap-2 mx-auto"
                        >
      ...
      <footer className="bg-white border-t border-gray-100 py-12">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-6 text-sm text-gray-500">
                <a href="#" className="hover:text-gray-900">Get License</a>
